...
<div class="container create-container">
    <form action="{{route('gudang.barang_store')}}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card bg-light border-3 border-info table-card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kode_barang') is-invalid @enderror" name="kode_barang" value="{{old('kode_barang')}}" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="deskripsi_barang" class="form-control @error('deskripsi_barang') is-invalid @enderror" name="deskripsi_barang" value="{{old('deskripsi_barang')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('harga_barang') is-invalid @enderror" name="harga_barang" value="{{old('harga_barang')}}">
